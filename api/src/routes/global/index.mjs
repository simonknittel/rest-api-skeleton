...
generalRouter.route('/authenticated').get(authenticateMiddleware, checkPermissionsMiddleware([2]), authenticatedRoute).all(allowedMethods(['GET']))
...
generalRouter.route('/signup').post(signupRoute).all(allowedMethods(['POST']))
