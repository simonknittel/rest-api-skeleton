...
generalRouter.route('/authenticated').get(authenticateMiddleware, checkPermissionsMiddleware([2]), (req, res) => { res.send(res.locals.authentication) }).all(allowedMethods(['GET']))
